...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString) || connectionString.Contains("YOUR_RDS_ENDPOINT", StringComparison.OrdinalIgnoreCase))
        {
            connectionString = "Server=localhost;Port=3306;Database=civicherodb;Uid=root;Pwd=;SslMode=Preferred;";
        }
