...
export default function RewardsOverview() {
  ...
  const progress = useMemo(() => Math.min(100, ((points?.balance || 0) / Math.max(1, points?.nextTierAt || 100)) * 100), [points]);
