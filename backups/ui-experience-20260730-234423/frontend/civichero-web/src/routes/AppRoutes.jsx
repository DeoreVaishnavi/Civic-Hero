...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route element={<ProtectedRoute />}><Route path={ROUTE_PATHS.dashboard} element={<DashboardRedirect />} /><Route path={ROUTE_PATHS.accessDenied} element={<AccessDeniedPage />} />
      <Route element={<RoleGuard roles={['Citizen']} />}><Route path="/citizen" element={<CitizenLayout />}><Route index element={<CitizenDashboard />} /><Route path="report" element={<ReportComplaint />} /><Route path="complaints" element={<MyComplaints />} /><Route path="complaints/:id" element={<ComplaintDetailsAddon />} /><Route path="nearby" element={<CommonIssues />} /><Route path="verifications" element={<CitizenVerification />} /><Route path="disputes" element={<DisputePage />} /><Route path="rewards" element={<RewardsOverview />} /><Route path="leaderboard" element={<Leaderboard />} /><Route path="heatmap" element={<Heatmap />} /><Route path="issues/:id" element={<UpvotePage />} /><Route path="complaints/:id/timeline" element={<ComplaintTimeline />} /><Route path="chatbot" element={<Chatbot />} /><Route path="notifications" element={<NotificationsPage />} /><Route path="profile" element={<Profile />} /><Route path="security" element={<AccountSecurity />} /></Route></Route>
      <Route element={<RoleGuard roles={['Officer']} />}><Route path="/officer" element={<OfficerLayout />}><Route index element={<OfficerDashboard />} /><Route path="assignments" element={<WorkQueue />} /><Route path="assignments/:complaintId" element={<AssignmentDetailsAddon />} /><Route path="assignments/:complaintId/resolve" element={<UploadResolution />} /><Route path="notifications" element={<NotificationsPage />} /><Route path="profile" element={<Profile />} /><Route path="security" element={<AccountSecurity />} /></Route></Route>
      <Route element={<RoleGuard roles={['Supervisor']} />}><Route path="/supervisor" element={<SupervisorLayout />}><Route index element={<SupervisorDashboard />} /><Route path="assignments" element={<AssignmentQueue />} /><Route path="assignments/:complaintId" element={<ManageAssignmentAddon />} /><Route path="overdue" element={<OverdueAssignments />} /><Route path="emergency-reviews" element={<EmergencyReviewQueue />} /><Route path="comment-moderation" element={<CommentModerationQueue />} /><Route path="visual-verification" element={<VisualVerificationQueue />} /><Route path="verifications" element={<VerificationQueue />} /><Route path="disputes" element={<DisputeQueue />} /><Route path="disputes/:id" element={<DisputeReview />} /><Route path="analytics" element={<TeamAnalytics />} /><Route path="notifications" element={<NotificationsPage />} /><Route path="profile" element={<Profile />} /><Route path="security" element={<AccountSecurity />} /></Route></Route>
      <Route element={<RoleGuard roles={['Admin', 'SuperAdmin']} />}><Route path="/admin" element={<AdminLayout />}><Route index element={<AdminDashboard />} /><Route path="users" element={<UserManagement />} /><Route path="emergency-reviews" element={<EmergencyReviewQueue />} /><Route path="comment-moderation" element={<CommentModerationQueue />} /><Route path="visual-verification" element={<VisualVerificationQueue />} /><Route path="appeals" element={<AppealManagement />} /><Route path="verifications" element={<VerificationHistory />} /><Route path="broadcast" element={<BroadcastNotifications />} /><Route path="ai-review" element={<FraudReviewQueue />} /><Route path="analytics" element={<AnalyticsDashboard />} /><Route path="reports" element={<Reports />} /><Route path="governance" element={<Governance />} /><Route path="audit-logs" element={<AuditLogs />} /><Route path="system-health" element={<SystemHealth />} /><Route path="security-center" element={<SecurityCenter />} /><Route path="quality-center" element={<QualityCenter />} /><Route path="release-center" element={<ReleaseCenter />} /><Route path="launch-center" element={<LaunchCenter />} /><Route path="integration-center" element={<IntegrationCenter />} /><Route path="final-release" element={<FinalReleaseCenter />} /><Route path="notifications" element={<NotificationsPage />} /><Route path="profile" element={<Profile />} /><Route path="security" element={<AccountSecurity />} /></Route></Route>
    </Route>
