...
export default function AccountSecurity() {
  ...
  return (
    <section className="mx-auto max-w-5xl space-y-6 p-6">
      {location.state?.twoFactorSetupRequired && <div className="rounded-2xl border border-amber-300/30 bg-amber-300/10 p-5 text-amber-100"><h2 className="text-xl font-black">Two-factor enrollment required</h2><p className="mt-2 text-sm">Your role now requires two-factor authentication. Complete setup before {formatDate(location.state.twoFactorSetupDeadlineUtc)}. After the grace period, login will be blocked until a SuperAdmin grants a new enrollment window.</p></div>}
      <div>
