...
export default function AppRoutes() {
  return <Routes>
    <Route element={<PublicLayout />}><Route path={ROUTE_PATHS.home} element={<HomePage />} /><Route path={ROUTE_PATHS.publicIssues} element={<PublicIssuesPage />} /><Route path={ROUTE_PATHS.projects} element={<ProjectsPage />} /><Route path={ROUTE_PATHS.login} element={<LoginPage />} /><Route path={ROUTE_PATHS.forgotPassword} element={<ForgotPasswordPage />} /><Route path={ROUTE_PATHS.resetPassword} element={<ResetPasswordPage />} /><Route path={ROUTE_PATHS.register} element={<RegisterPage />} /><Route path={ROUTE_PATHS.verifyEmail} element={<VerifyEmailPage />} /><Route path={ROUTE_PATHS.anonymousReport} element={<AnonymousReportPage />} /><Route path={ROUTE_PATHS.anonymousTrack} element={<AnonymousTrackPage />} /></Route>
