...
public sealed class VisualVerificationService : IVisualVerificationService
{
    ...
    private readonly PythonVisualVerificationProvider _python;
    ...
    public VisualVerificationService(
        ...
        PythonVisualVerificationProvider python,
    ...
    public async Task<VisualVerificationResponse> AnalyzeComplaintAsync(long complaintId, CancellationToken cancellationToken = default)
    {
        ...
        var result = await _python.AnalyzeAsync(complaint, before, after, cancellationToken)
                     ?? await _gemini.AnalyzeAsync(complaint, before, after, cancellationToken)
