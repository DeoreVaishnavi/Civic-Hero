...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route element={<ProtectedRoute />}><Route path={ROUTE_PATHS.dashboard} element={<DashboardRedirect />} /><Route path={ROUTE_PATHS.accessDenied} element={<AccessDeniedPage />} />
      ...
      <Route element={<RoleGuard roles={['Supervisor']} />}><Route path="/supervisor" element={<SupervisorLayout />}><Route index element={<SupervisorDashboard />} /><Route path="assignments" element={<AssignmentQueue />} /><Route path="assignments/:complaintId" element={<ManageAssignment />} /><Route path="overdue" element={<OverdueAssignments />} /><Route path="profile" element={<Profile />} /></Route></Route>
