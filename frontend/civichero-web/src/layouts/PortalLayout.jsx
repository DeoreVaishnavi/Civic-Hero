      ...
      <main className="min-w-0">
        <header className="border-b border-white/10 bg-slate-950/80 px-6 py-5 backdrop-blur">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3"><NotificationBell basePath={basePath} /><button onClick={handleLogout} className="rounded-lg border border-white/15 px-3 py-2 text-sm font-semibold hover:bg-white/10 lg:hidden">Logout</button></div>
          </div>
        </header>
        <Outlet />
      </main>
