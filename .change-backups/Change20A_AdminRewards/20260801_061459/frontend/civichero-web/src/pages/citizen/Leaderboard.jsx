  ...
  return (
    <section className="page-wrap">
      ...
      <div className="filter-bar">
        <select className="input" value={filters.range} onChange={(event) => setFilters({ ...filters, range: event.target.value })}>
          <option>All time</option><option>This month</option><option>This year</option>
        </select>
        <select className="input" value={filters.ward} onChange={(event) => setFilters({ ...filters, ward: event.target.value })}>
