...
public interface IAssignmentService
{
    ...
    Task<AssignmentDto> RequestTransferAsync(long complaintId, TransferAssignmentRequest request, CancellationToken cancellationToken = default);
    ...
    Task<AssignmentDto> AddProgressWithEvidenceAsync(long complaintId, AddProgressEvidenceRequest request, CancellationToken cancellationToken = default);
    Task<AssignmentDto> RequestCitizenInformationAsync(long complaintId, OfficerCitizenInformationRequest request, CancellationToken cancellationToken = default);
    ...
    Task<OfficerPerformanceDto> GetOfficerPerformanceAsync(int days, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<OfficerMapItemDto>> GetOfficerMapAsync(CancellationToken cancellationToken = default);
