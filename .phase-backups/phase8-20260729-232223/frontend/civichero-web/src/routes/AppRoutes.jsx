...
import AppealReview from '../pages/admin/AppealReview.jsx';
import CitizenDashboard from '../pages/citizen/CitizenDashboard.jsx';
import VerificationCenter from '../pages/citizen/VerificationCenter.jsx';
...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route element={<ProtectedRoute />}><Route path={ROUTE_PATHS.dashboard} element={<DashboardRedirect />} /><Route path={ROUTE_PATHS.accessDenied} element={<AccessDeniedPage />} />
      <Route element={<RoleGuard roles={['Citizen']} />}><Route path="/citizen" element={<CitizenLayout />}><Route index element={<CitizenDashboard />} /><Route path="report" element={<ReportComplaint />} /><Route path="complaints" element={<MyComplaints />} /><Route path="complaints/:id" element={<ComplaintDetails />} /><Route path="nearby" element={<CommonIssues />} /><Route path="verification" element={<VerificationCenter />} /><Route path="disputes" element={<DisputePage />} /><Route path="profile" element={<Profile />} /></Route></Route>
      ...
      <Route element={<RoleGuard roles={['Supervisor']} />}><Route path="/supervisor" element={<SupervisorLayout />}><Route index element={<SupervisorDashboard />} /><Route path="assignments" element={<AssignmentQueue />} /><Route path="assignments/:complaintId" element={<ManageAssignment />} /><Route path="overdue" element={<OverdueAssignments />} /><Route path="verification" element={<VerificationQueue />} /><Route path="disputes" element={<DisputeQueue />} /><Route path="profile" element={<Profile />} /></Route></Route>
      <Route element={<RoleGuard roles={['Admin', 'SuperAdmin']} />}><Route path="/admin" element={<AdminLayout />}><Route index element={<AdminDashboard />} /><Route path="users" element={<UserManagement />} /><Route path="appeals" element={<AppealReview />} /><Route path="profile" element={<Profile />} /></Route></Route>
    </Route>
