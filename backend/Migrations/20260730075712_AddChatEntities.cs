        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComplaintUpdates_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimilarityScore = table.Column<double>(type: "double", nullable: false),
                    IssueStillVisible = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AnalysisDetails = table.Column<string>(type: "text", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resolution_verification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_resolution_verification_Complaints_ComplaintId",
                        column: x => x.ComplaintId,
                        principalTable: "Complaints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintUpdates_UserId1",
                table: "ComplaintUpdates",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_resolution_verification_ComplaintId",
                table: "resolution_verification",
                column: "ComplaintId");

            migrationBuilder.AddForeignKey(
                name: "FK_ai_fraud_analysis_Complaints_ComplaintId",
